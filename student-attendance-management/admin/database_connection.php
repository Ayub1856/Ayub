...
$con = new mysqli('localhost','root','','attendance_management');

if($con){
}else{
  die(mysqli_error($con));
}
$connect = new PDO("mysql:host=localhost;dbname=attendance_management","root","");

$connect = new PDO("mysql:host=localhost;dbname=attendance_management","root","");

$base_url = "http://localhost/student-attendance-management/";
